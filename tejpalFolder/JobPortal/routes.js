...
router.get("/aboutus", ifNotLoggedin, aboutus);

router.get("/employer", ifNotLoggedin, employer);

router.get("/news", ifNotLoggedin, news);

router.get("/contactus", ifNotLoggedin, contactus);

router.get('/jobseeker', ifNotLoggedin, jobseeker);
